...
<section class="products">
   ...
   <h1 class="heading">Smart Watch </h1>
  <div class="categories" style= "display: flex;
    font-size: 2rem;
    margin: 1rem;
    justify-content: center";> 
    <a href="shop.php" style="padding-right: 2rem"> All products </a>
    <a href="laptop.php " style="padding-right: 2rem"> Laptop </a>
    <a href="mobile.php"> Mobile phone </a>
</div>
   <div class="box-container">

   <?php
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE category='SmartWatch'"); 
